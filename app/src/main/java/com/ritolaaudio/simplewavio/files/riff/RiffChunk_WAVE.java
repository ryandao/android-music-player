	...
	public double [][] getAudioAsFloats()
		...
		for(int frameIndex=0; frameIndex<numFrames; frameIndex++)
			...
			for(int c=0; c<channelCount; c++)
				...
				result[frameIndex][c]=(double)sample;
				}//end for(channel)
			}//end for(frameIndex)
		return result;
		}//end getFloats
	
	public void setAudioFromFloats(double [][]buffer)
		{
		int intValue;
